...
/*     public IEnumerator FOVKickOut()
    ...
    public class FPAIO_Editor : Editor{
        ...
        #region Camera Setup
            ...
            t.verticalRotationRange = EditorGUILayout.Slider(new GUIContent("Vertical Rotation Range","Determines how much range does the camera have to move vertically."),t.verticalRotationRange,0,180);
